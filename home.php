            ...
            <div class="mt-14 px-4 mx-auto">
                ...
                <div style="box-shadow: rgba(0, 0, 0, 0.16) 0px 10px 36px 0px, rgba(0, 0, 0, 0.06) 0px 0px 0px 1px;" class="mt-4 w-full absolute left-0 parent rounded-lg">
                    ...
                    <div class="pt-2 relative mx-auto text-gray-600">
                        <input id="search-input" class="border-2 border-gray-300 w-full bg-white h-14 pl-12 pr-24 rounded-b-lg text-xl focus:outline-none" type="search" name="search" placeholder="Pesquisar" oninput="search()">
                ...
                <div class="h-screen lg:w-8/12 mx-auto mt-48">
                    <div id="grid-container" class="grid-container">
                        <?php foreach ($category as $categories) {
                            $productsFilter = get_products($categories['id']);
                            if (!empty($productsFilter)) { ?>
                                <h6 class="grid-title font-bold text-2xl mt-8"><?php echo $categories['name'] ?></h6>
                                <div class="grid md:grid-cols-2 gap-4 md:gap-12 mt-4">
                                    <?php
                                    foreach ($productsFilter as $products) { ?>
                                        <div class="grid-item">
                                            <a href="#" class="flex flex-row bg-white h-44 md:h-52 border border-gray-200 rounded-lg shadow md:max-w-xl hover:bg-gray-100">
                                                <img class="object-cover md:h-auto w-2/5 rounded-l-lg" src="assets/img/logo.jpg" alt="">
                                                <div class="flex flex-col justify-between p-4 leading-normal">
                                                    <h5 class="mb-2 md:text-lg font-bold tracking-tight text-gray-900 line-clamp-2 max-w-full"><?php echo $products['name']?></h5>
                                                    <p class="mb-3 font-normal text-gray-700 line-clamp-2 md:line-clamp-3"><?php echo $products['description']?></p>
                                                    <span class="text-xl font-bold text-gray-900 drop-shadow-xl">R$ <?php echo $products['price']?></span>
                                                </div>
                                            </a>
...
<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onclick="openModal()">Exibir Modal</button>

<!-- Modal -->
<div id="myModal" class="bg-white w-full h-screen fixed top-0 z-50 right-0 transform translate-x-full transition-all duration-500 ease-in-out">
  <div class="p-6">
    <h2 class="text-lg font-bold mb-4">Título do Modal</h2>
    <p>Conteúdo do Modal aqui...</p>
    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4" onclick="closeModal()">Fechar Modal</button>
  </div>
</div>
...
<script>
  function openModal() {
    document.getElementById("myModal").classList.remove("translate-x-full");
  }
  
  function closeModal() {
    document.getElementById("myModal").classList.add("translate-x-full");
  }
</script>
